...
<head>
  <link rel="apple-touch-icon" href="/sites/all/themes/razum/images/logo-ios.png" />
...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  <?php if (theme_get_setting('idevtheme_browser_ie6')): ?>
	<!-- update ie6 message -->
	<!--[if IE 6]>
      <style type="text/css">
  ...
  <?php if (theme_get_setting('idevtheme_browser_nojs')): ?>
  <!-- noscript -->
  <noscript><div class="noscript"><?php echo theme_get_setting('idevtheme_browser_nojs_label'); ?></div></noscript>
  <?php endif; ?>
